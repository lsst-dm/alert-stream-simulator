...
type Alert struct {
	...
	// unique alert identifer
		...
		PrvDiaSources *UnionNullArrayDiaSource
	

	
	
		PrvDiaForcedSources *UnionNullArrayDiaForcedSource
	

	
	
		PrvDiaNondetectionLimits *UnionNullArrayDiaNondetectionLimit
	

	
	
		DiaObject *UnionNullDiaObject
	

	
	
		SsObject *UnionNullSsObject
...
const AlertAvroCRC64Fingerprint = "\x136!\xaeUw}\xf9"
...
func writeAlert(r *Alert, w io.Writer) error {
	...
	err = vm.WriteLong( r.AlertId, w)
	if err != nil {
		return err
	}
	
	err = writeDiaSource( r.DiaSource, w)
	if err != nil {
		return err
	}
	
	err = writeUnionNullArrayDiaSource( r.PrvDiaSources, w)
	if err != nil {
		return err
	}
	
	err = writeUnionNullArrayDiaForcedSource( r.PrvDiaForcedSources, w)
	if err != nil {
		return err
	}
	
	err = writeUnionNullArrayDiaNondetectionLimit( r.PrvDiaNondetectionLimits, w)
	if err != nil {
		return err
	}
	
	err = writeUnionNullDiaObject( r.DiaObject, w)
	if err != nil {
		return err
	}
	
	err = writeUnionNullSsObject( r.SsObject, w)
	if err != nil {
		return err
	}
...
func (r *Alert) Get(i int) types.Field {
	...
	case 0:
			...
			return (*types.Long)(&r.AlertId)
		
	
	case 1:
		
			r.DiaSource = NewDiaSource()
	...
	case 2:
			...
			r.PrvDiaSources = NewUnionNullArrayDiaSource()

		
		
			return r.PrvDiaSources
		
	
	case 3:
		
			r.PrvDiaForcedSources = NewUnionNullArrayDiaForcedSource()

		
		
			return r.PrvDiaForcedSources
		
	
	case 4:
		
			r.PrvDiaNondetectionLimits = NewUnionNullArrayDiaNondetectionLimit()

		
		
			return r.PrvDiaNondetectionLimits
		
	
	case 5:
		
			r.DiaObject = NewUnionNullDiaObject()
	...
	case 6:
			...
			r.SsObject = NewUnionNullSsObject()
